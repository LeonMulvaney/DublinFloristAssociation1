package com.groupo.dublinfloristassociation;//add your package name here example: package com.example.dbm;
...
public class AndroidDatabaseManagerDELETEWHENCOMPLETE extends Activity implements OnItemClickListener {
...
// all global variables
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class name
		dbm = new DBhandler(AndroidDatabaseManagerDELETEWHENCOMPLETE.this, null, null, 1);
		
		mainscrollview = new ScrollView(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		...
		//the main linear layout to which all tables spinners etc will be added.In this activity every element is created dynamically  to avoid using xml file
		 mainLayout = new LinearLayout(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		...
		final LinearLayout firstrow = new LinearLayout(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		firstrow.setPadding(0,10,0,20);
		LinearLayout.LayoutParams firstrowlp = new LinearLayout.LayoutParams(0, 150);
		firstrowlp.weight = 1;

		TextView maintext = new TextView(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		maintext.setText("Select Table");
		maintext.setTextSize(22);
		maintext.setLayoutParams(firstrowlp);
		select_table=new Spinner(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		...
		ArrayList<Cursor> alc ;
		 ...
		 hsv = new HorizontalScrollView(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);

		 //the main table layout where the content of the sql tables will be displayed when user selects a table	
    		 tableLayout = new TableLayout(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
    		 tableLayout.setHorizontalScrollBarEnabled(true);
    		 hsv.addView(tableLayout);

		//the second row of the layout which shows number of records in the table selected by user
		final LinearLayout secondrow = new LinearLayout(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		...
		TextView secondrowtext = new TextView(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		secondrowtext.setText("No. Of Records : ");
		secondrowtext.setTextSize(20);
		secondrowtext.setLayoutParams(secondrowlp);
		tv =new TextView(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		tv.setTextSize(20);
		...
		final Button submitQuery = new Button(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		...
		final TextView help = new TextView(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		...
		final Spinner spinnertable =new Spinner(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		...
		final LinearLayout thirdrow = new LinearLayout(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		previous = new Button(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		previous.setText("Previous");
		
		previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
		previous.setLayoutParams(secondrowlp);
		next = new Button(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		next.setText("Next");
		...
		tvmessage =new TextView(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
		...
		final Button customQuery = new Button(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
       ...
       // a query which returns a cursor with the list of tables in the database.We use this cursor to populate spinner in the first row
		...
		do{
			...
			ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(AndroidDatabaseManagerDELETEWHENCOMPLETE.this,
        ...
        tablenamesadapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item); 
		 ...
		 select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			// a array adapter which add values to the spinner which helps in user making changes to the table
	                ArrayAdapter<String> adapter = new ArrayAdapter<String>(AndroidDatabaseManagerDELETEWHENCOMPLETE.this,
	            	    ...
	            	    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
	                    		...
	                    		runOnUiThread(new Runnable() {
	                    			   ...
	                    			   public void run() {
	                    				if(!isFinishing()){
		                    						        ...
		                    						        new AlertDialog.Builder(AndroidDatabaseManagerDELETEWHENCOMPLETE.this)
	                    	...
	                    	if(spinnertable.getSelectedItem().toString().equals("Add row to this table"))
	                    	{
	                    		...
	                    		final LinkedList<TextView> addnewrownames = new LinkedList<TextView>();
	                        	  ...
	                        	  final ScrollView addrowsv =new ScrollView(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
	                            ...
	                            final RelativeLayout addnewlayout = new RelativeLayout(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
	                        	...
	                        	addnewparams.addRule(RelativeLayout.ALIGN_PARENT_TOP);
	                        	    ...
	                        	    et.setId(k);
	                        	    final LinearLayout ll = new LinearLayout(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
	                ...
	                {
	                 LinearLayout cell = new LinearLayout(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
	...
	//edit texts which has the values of the row which user has selected
      ...
      final RelativeLayout lp = new RelativeLayout(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
      lp.setBackgroundColor(Color.WHITE);
  	  RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
  	  lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);
  	  
  	  final ScrollView updaterowsv =new ScrollView(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
  	  LinearLayout lcrud = new LinearLayout(AndroidDatabaseManagerDELETEWHENCOMPLETE.this);
  	  ...
  	  //spinner which displays update , delete options
          ...
          ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(AndroidDatabaseManagerDELETEWHENCOMPLETE.this,
